products = {
  "Savings Account": {
    ...
    "description": (
        "A deposit account designed for saving money "
        "while generally providing access to funds."
    ),
    ...
    "Business Loan": {
        "features": [
            ...
            "Funds for equipment, expansion, or working capital"
        ],
        "common_questions": [
    ...
    "Insurance": {
        "features": [
            "Life and property protection options",
